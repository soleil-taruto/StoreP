...
var<Image> P_Circle_Hard = @@_Load(Resources.Picture__正方形ブロック_Hard_png); // 硬い
var<Image> P_Circle_Norm = @@_Load(Resources.Picture__正方形ブロック_Norm_png); // 硬さ普通
var<Image> P_Circle_Soft = @@_Load(Resources.Picture__正方形ブロック_Soft_png); // 柔らかい
