...
namespace Charlotte.Games.Enemies
{
	...
	public static class EnemyCatalog
	{
		...
		private static EnemyInfo[] Enemies = new EnemyInfo[]
		{
			...
			new EnemyInfo("即死トラップ-杭", () => new Enemy_即死トラップ針(X, Y, Ground.I.Picture.Stage01_Chip_f01)),
			...
			new EnemyInfo("即死トラップ/即死トラップ-針(右)", () => new Enemy_即死トラップ針(X, Y, Ground.I.Picture.Stage02_Chip_e01)),
			new EnemyInfo("即死トラップ/即死トラップ-針(下)", () => new Enemy_即死トラップ針(X, Y, Ground.I.Picture.Stage02_Chip_e02)),
			new EnemyInfo("即死トラップ/即死トラップ-針(左)", () => new Enemy_即死トラップ針(X, Y, Ground.I.Picture.Stage02_Chip_e03)),
			new EnemyInfo("即死トラップ/即死トラップ-針(上)", () => new Enemy_即死トラップ針(X, Y, Ground.I.Picture.Stage02_Chip_e04)),
