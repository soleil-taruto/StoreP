...
namespace Charlotte.Games.Enemies
{
	...
	public static class EnemyCatalog
	{
		...
		private static EnemyInfo[] Enemies = new EnemyInfo[]
		{
			...
			new EnemyInfo("テスト用/アイテム・ファイアボール", () => new Enemy_Bアイテム(X, Y, Enemy_Bアイテム.効用_e.WEAPON_FIRE_BALL)),
			new EnemyInfo("テスト用/アイテム・レーザー", () => new Enemy_Bアイテム(X, Y, Enemy_Bアイテム.効用_e.WEAPON_LASER)),
			new EnemyInfo("テスト用/アイテム・波動ビーム", () => new Enemy_Bアイテム(X, Y, Enemy_Bアイテム.効用_e.WEAPON_WAVE_BEAM)),
