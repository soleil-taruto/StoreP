...
function* <generatorForTask> Scenario_Stage03()
{
	...
	for (var<int> c = 0; c < 10; c++)
	{
		GetEnemies().push(CreateEnemy_E0007(GetRand3(50, 650), -25, 5));
	...
	GetEnemies().push(EnemyCommon_ToItemer(
		CreateEnemy_E0003(GetRand3(150, 550), -25, 5),
	...
	GetEnemies().push(EnemyCommon_ToItemer(
		CreateEnemy_E0004(GetRand3(150, 550), -25, 5),
	...
	for (var<int> c = 0; c < 10; c++)
	{
		GetEnemies().push(EnemyCommon_ToShooter(
			CreateEnemy_E0008(GetRand3(50, 650), -25, 5)
			));
