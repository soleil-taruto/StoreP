...
var<Picture_t> P_PlayerAttack = @@_Load(RESOURCE_Emukuro__CirnoAttack_png);
var<Picture_t> P_PlayerStand  = @@_Load(RESOURCE_Emukuro__CirnoStand_png);
var<Picture_t> P_PlayerJump   = @@_Load(RESOURCE_Emukuro__CirnoJump_png);

var<Picture_t[]> P_PlayerRun =
[
	@@_Load(RESOURCE_Emukuro__CirnoRun_001_png),
	@@_Load(RESOURCE_Emukuro__CirnoRun_002_png),
	@@_Load(RESOURCE_Emukuro__CirnoRun_003_png),
	@@_Load(RESOURCE_Emukuro__CirnoRun_004_png),
];

// プレイヤー_Mirror

var<Picture_t> P_PlayerMirrorAttack = @@_Load(RESOURCE_Emukuro__Mirror__CirnoAttack_png);
var<Picture_t> P_PlayerMirrorStand  = @@_Load(RESOURCE_Emukuro__Mirror__CirnoStand_png);
var<Picture_t> P_PlayerMirrorJump   = @@_Load(RESOURCE_Emukuro__Mirror__CirnoJump_png);

var<Picture_t[]> P_PlayerMirrorRun =
[
	@@_Load(RESOURCE_Emukuro__Mirror__CirnoRun_001_png),
	@@_Load(RESOURCE_Emukuro__Mirror__CirnoRun_002_png),
	@@_Load(RESOURCE_Emukuro__Mirror__CirnoRun_003_png),
	@@_Load(RESOURCE_Emukuro__Mirror__CirnoRun_004_png),
];
...
var<Picture_t> P_Wall0001 = @@_Load(RESOURCE_SozaiGood__Wall_0001_png);
