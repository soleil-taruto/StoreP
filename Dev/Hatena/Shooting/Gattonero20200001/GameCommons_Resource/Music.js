...
var<Sound_t> M_Stage01Boss = @@_Load(RESOURCE_Youfulca__Battle_Vampire_loop_mp3);
var<Sound_t> M_Stage02Boss = @@_Load(RESOURCE_Youfulca__Battle_Conflict_loop_mp3);
var<Sound_t> M_Stage03Boss = @@_Load(RESOURCE_Youfulca__Battle_rapier_loop_mp3);
